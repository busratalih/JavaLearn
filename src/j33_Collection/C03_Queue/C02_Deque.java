...
public class C02_Deque {
    public static void main(String[] args) {
        ...
        /*
        Deque : Double Ended Queue -> Queue'larda FİFO Deque erde hem FİFO hem LİFO gecerli
        LİFO : Last in First out
         */

        Deque<String> dq1=new LinkedList<>(Arrays.asList("Küsleme", "onkol", "Bobrek yatagi", "ezme", "haydari"));
