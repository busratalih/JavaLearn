...
public class C03_PassByValue {
    public static void main(String[] args) {
       ...
       /*
       java non-primitive (class array list ->referans)  data turlerinde objenın kendisi değil de dataları degişirse
        objenın referans ve kendisi değişmediği dataları değişikligini kalıcı yapar
        */
