 ...
 */
    ...
    public static void main(String[] args) {
      ...
      // System.out.println("obj1.id = " + obj1.id); //333
       ...
       obj1.isimDegis("Dilek Teamlead"); //dilek hanım ism dilek teamlead olarak set edildi
        System.out.println("obj1.isimVer() = " + obj1.isimVer()); //dilek teamlead

        System.out.println("obj2.idVer() = " + obj2.idVer()); //1001
        System.out.println("obj2.isimVer() = " + obj2.isimVer());//gamze hanim
        obj2.isimDegis("gamze hanim scrum master");
        System.out.println("obj2.isimVer() = " + obj2.isimVer());//gamze scrum master
        System.out.println("obj2 = " + obj2); //C02_Encapsulation{name='gamze hanim scrum master', id=1001}
